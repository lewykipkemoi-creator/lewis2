...
function statusStyle(status: string) {
  ...
  if (status === "Available") return "border-transparent text-white/35";
...
export default function CalendarPage() {
  return (
    <div className="max-w-5xl px-4 sm:px-6 lg:px-10 py-6 lg:py-8">
      ...
      <Reveal delay={100} className="rounded-2xl border border-transparent bg-white/[0.02] mt-8 divide-y divide-transparent max-w-lg">
